...
const Procesadores = () => {
  ...
  // Función para obtener los procesadores de la API
  useEffect(() => {
    const fetchProcesadores = async () => {
      try {
        ...
        setProducts(procesadores);
        setLoading(false);
      } catch (err) {
        console.error('Error al cargar los procesadores:', err);
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="h5" align="center" color="text.secondary" paragraph>
          Descubre nuestra selección de procesadores de alto rendimiento
        </Typography>
      </Box>
            ...
            <Grid item key={product._id} xs={12} sm={6} md={4} lg={3}>
              <Card sx={{ 
                ...
                <CardMedia
                  component="img"
                  height="180"
                  image={product.image || 'https://via.placeholder.com/300x200?text=CPU'}
                  alt={product.name}
            ...
            <DialogContent sx={{ pt: 3 }}>
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <CardMedia
                    component="img"
                    image={selectedProduct.image || 'https://via.placeholder.com/300x200?text=CPU'}
